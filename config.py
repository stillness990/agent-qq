...
class Settings(BaseSettings):
    ...
    # --- Worker pool ---
    worker_pool_enabled: bool = Field(default=True, alias="WORKER_POOL_ENABLED")
    worker_pool_size: int = Field(default=4, alias="WORKER_POOL_SIZE")
    worker_poll_interval: float = Field(default=0.5, alias="WORKER_POLL_INTERVAL")
    task_max_age_hours: int = Field(default=24, alias="TASK_MAX_AGE_HOURS")
